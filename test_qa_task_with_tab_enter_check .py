...
AccountPaternUrl = "/html/body/div/div[2]/div/div[1]/span[2]"
...
# CHeck tab in signin
    def test_case28(self):
        ...
        WebDriverWait(self.driver, 5).until(lambda driver: self.driver.find_element_by_class_name(SignInUrl)).click()
        self.driver.execute_script("window.scrollTo(0, 300)") 
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/tast28_case.png')
        self.driver.find_element_by_id(EmailCreateUrl).click()
        time.sleep(2)
        act = ActionChains(self.driver)
        for i in range(1,6):
            act.send_keys(Keys.TAB).perform()
            self.driver.save_screenshot("C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/tast28_case" + str(i) + ".png")
            time.sleep(4)
        self.driver.quit()
...
# CHeck tab in in registration form
    def test_case29(self):
        ...
        self.driver.execute_script("window.scrollTo(0, 300)")
        self.driver.find_element_by_id(EmailCreateUrl).send_keys("jakubtest123@gmail.com")
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/test29_case.png')
        self.driver.find_element_by_id(SubmitCreateUrl).click()
        time.sleep(3)
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/test29_case.png')
        act = ActionChains(self.driver)
        for i in range(15):
            act.send_keys(Keys.TAB).perform()
            time.sleep(3)
            self.driver.save_screenshot("C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/tast29_case" + str(i) + ".png")
        self.driver.quit()

#Click enter on create an account instead of click on (EmailCreateUrl).click()
    def test_case30(self):
        ...
        WebDriverWait(self.driver, 5).until(lambda driver: self.driver.find_element_by_class_name(SignInUrl)).click()
        self.driver.execute_script("window.scrollTo(0, 300)") 
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/tast30_case.png')
        self.driver.find_element_by_id(EmailCreateUrl).send_keys("jakubtest123@gmail.com")
        time.sleep(2)
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/test30_case.png')
        act = ActionChains(self.driver)
        act.send_keys(Keys.ENTER).perform()
        time.sleep(2)
        status = self.driver.find_element_by_xpath(AccountPaternUrl).is_displayed()
        if status == True:
            assert True
        else:
            assert False
...
# Click enter on in login form instead of click on (EmailCreateUrl).click()
    def test_case31(self):
        ...
        self.driver.execute_script("window.scrollTo(0, 300)") 
        self.driver.find_element_by_id(LoginEmailUrl).send_keys("jakub123@gmail.com")
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/tast31_case1.png')
        self.driver.find_element_by_id(LoginPassUrl).send_keys("k1234")
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/tast31_case2.png')
        act = ActionChains(self.driver)
        act.send_keys(Keys.ENTER).perform()
        time.sleep(1)
        self.driver.save_screenshot('C:/Users/stawowcz/Desktop/moje/sofomo_zadanie/test_pictures/tast31_case3.png')
        time.sleep(3)
        status = self.driver.find_element_by_xpath(AccountPaternUrl).is_displayed()
        if status == True:
            assert True
